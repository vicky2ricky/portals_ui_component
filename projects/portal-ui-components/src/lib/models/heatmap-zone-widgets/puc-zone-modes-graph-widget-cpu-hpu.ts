...
/**
 * @description: Zone Modes Graph Widget CPU HPU
 */
export class PucZoneModesGraphWidgetCpuHpu {
    ...
    getGraphWidget() {
        ...
        params.push(new PucGraphWidgetParam('FanModeCpuHpuOff' + this.moduleIdentifier,
            PucGraphColors.GREY, PucGraphTypes.HORIZONTALLY_STACKED_MERGED, toolTip, 0));    // stacked-merged
        // fanAuto
        toolTip = new PucToolTipModel(true, 'FanMode', true);
        params.push(new PucGraphWidgetParam('FanModeCpuHpuAuto' + this.moduleIdentifier,
            PucGraphColors.OCEAN_GREEN, PucGraphTypes.HORIZONTALLY_STACKED_MERGED, toolTip, 0));    // stacked-merged
        // fanLow
        toolTip = new PucToolTipModel(true, 'FanMode', true);
        params.push(new PucGraphWidgetParam('FanModeCpuHpuLow' + this.moduleIdentifier,
            PucGraphColors.LIGHT_GRAYISH_CYAN_LIME_GREEN, PucGraphTypes.HORIZONTALLY_STACKED_MERGED, toolTip, 0));    // stacked-merged
        // fanHigh
        toolTip = new PucToolTipModel(true, 'FanMode', true);
        params.push(new PucGraphWidgetParam('FanModeCpuHpuHigh' + this.moduleIdentifier,
